...
const FullPost = () => {
  ...
  if (Object.keys(postData).length !== 0) {
    let control = <></>
    let linkEdit = `/articles/${id}/edit`

    if (author.username === userName) {
      control = (
        <div className={stylesTwo.butWrapper}>
          <Popconfirm title="Are you sure to delete this article?" onConfirm={deleteArticle} okText="Yes" cancelText="No" placement={'right'} overlayClassName={stylesTwo.popconfirm}>
